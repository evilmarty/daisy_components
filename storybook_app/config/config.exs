...
config :storybook_app, StorybookAppWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: StorybookAppWeb.ErrorHTML, json: StorybookAppWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: StorybookApp.PubSub,
  live_view: [signing_salt: "/UZMMjHM"]
